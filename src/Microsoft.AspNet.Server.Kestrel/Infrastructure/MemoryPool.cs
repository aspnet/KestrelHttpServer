...
namespace Microsoft.AspNet.Server.Kestrel.Infrastructure
{
    ...
    public class MemoryPool : IDisposable
    {
        ...
        public const int NativeBlockSize = _blockLength;
        ...
        /// </summary>
        private readonly ConcurrentQueue<MemoryPoolSlab> _slabs = new ConcurrentQueue<MemoryPoolSlab>();
        ...
        public MemoryPoolBlock Lease(int minimumSize)
        {
