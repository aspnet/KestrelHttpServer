...
namespace Microsoft.AspNet.Server.Kestrel
{
    ...
    {
        static Action<ILogger, long, Exception> _connectionStart;
        static Action<ILogger, long, Exception> _connectionStop;
        static Action<ILogger, long, Exception> _connectionPause;
        static Action<ILogger, long, Exception> _connectionResume;
        static Action<ILogger, long, Exception> _connectionReadFin;
        static Action<ILogger, long, Exception> _connectionWriteFin;
        static Action<ILogger, long, int, Exception> _connectionWroteFin;
        static Action<ILogger, long, Exception> _connectionKeepAlive;
        static Action<ILogger, long, Exception> _connectionDisconnect;
