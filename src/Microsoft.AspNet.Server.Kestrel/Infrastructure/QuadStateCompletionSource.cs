...
{
    internal sealed class QuadStateCompletionSource<TState1, TState2, TState3, TState4, TResult> : INotifyCompletion, ICriticalNotifyCompletion
    {
        ...
        public QuadStateCompletionSource(TState1 state1, TState2 state2)
        {
            State1 = state1;
            State2 = state2;
        }
        ...
        public TState3 State3 { get; set; }
        public TState4 State4 { get; set; }
        ...
        public QuadStateCompletionSource<TState1, TState2, TState3, TState4, TResult> GetAwaiter() { return this; }
