...
{
    public sealed class StateCompletionSource<TState, TResult> : INotifyCompletion, ICriticalNotifyCompletion
    {
        ...
        public StateCompletionSource(TState state)
        {
            State = state;
        }
        ...
        public StateCompletionSource<TState, TResult> GetAwaiter() { return this; }
