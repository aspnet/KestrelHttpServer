...
#pragma warning restore xUnit1026
        ...
        public async Task RequestProcessingTaskIsUnwrapped()
        {
            ...
            await requestProcessingTask.TimeoutAfter(TimeSpan.FromSeconds(30));
            _application.Output.Complete();
        }
        ...
        public async Task AcceptsHeadersAcrossSends(int header0Count, int header1Count)
        {
            ...
            await WaitForCondition(TimeSpan.FromSeconds(30), () => _http1Connection.RequestHeaders != null);
            ...
            await WaitForCondition(TimeSpan.FromSeconds(30), () => _http1Connection.RequestHeaders.Count >= header0Count);
            ...
            await WaitForCondition(TimeSpan.FromSeconds(30), () => _http1Connection.RequestHeaders.Count >= header0Count + header1Count);
