...
namespace FunctionalTests
{
    public class RequestTests : LoggedTest
    {
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(LargeUpload)}_{contentLength}_{checkBytes}"))
            {
        ...
        public Task RemoteIPv4Address()
        {
            ...
            {
                return TestRemoteIPAddress("127.0.0.1", "127.0.0.1", "127.0.0.1", loggerFactory);
            }
        }
        ...
        public Task RemoteIPv6Address()
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel))
            {
                return TestRemoteIPAddress("[::1]", "[::1]", "::1", loggerFactory);
            }
        }
        ...
        public async Task ConnectionResetPriorToRequestIsLoggedAsDebug()
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel))
            {
                ...
                mockLoggerFactory
                    ...
                    .Returns(loggerFactory.CreateLogger(nameof(RequestTests)));
                mockLoggerFactory
        ...
        public async Task CanHandleRequestsWithUrlInAbsoluteForm(string requestUrl, string expectedPath, string queryValue)
        {
            ...
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(CanHandleRequestsWithUrlInAbsoluteForm)}_{requestUrl}_{expectedPath}_{queryValue}".RemoveIllegalFileChars()))
            using (var server = new TestServer(async context =>
                 {
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(Http11KeptAliveByDefault)}_{listenOptions.GetListenOptionsDetails()}"))
            {
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(Http10NotKeptAliveByDefault)}_{listenOptions.GetListenOptionsDetails()}"))
            {
                var testContext = new TestServiceContext() { LoggerFactory = loggerFactory };
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(Http10KeepAlive)}_{listenOptions.GetListenOptionsDetails()}"))
            {
                var testContext = new TestServiceContext() { LoggerFactory = loggerFactory };
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(Http10KeepAliveNotHonoredIfResponseContentLengthNotSet)}_{listenOptions.GetListenOptionsDetails()}"))
            {
                var testContext = new TestServiceContext() { LoggerFactory = loggerFactory };
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(Http10KeepAliveHonoredIfResponseContentLengthSet)}_{listenOptions.GetListenOptionsDetails()}"))
            {
                var testContext = new TestServiceContext() { LoggerFactory = loggerFactory };
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(Expect100ContinueHonored)}_{listenOptions.GetListenOptionsDetails()}"))
            {
                var testContext = new TestServiceContext() { LoggerFactory = loggerFactory };
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(ZeroContentLengthAssumedOnNonKeepAliveRequestsWithoutContentLengthOrTransferEncodingHeader)}_{listenOptions.GetListenOptionsDetails()}"))
            {
                var testContext = new TestServiceContext() { LoggerFactory = loggerFactory };
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(ConnectionClosesWhenFinReceivedBeforeRequestCompletes)}_{listenOptions.GetListenOptionsDetails()}"))
            {
                var testContext = new TestServiceContext() { LoggerFactory = loggerFactory };
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(RequestsCanBeAbortedMidRead)}_{listenOptions.GetListenOptionsDetails()}"))
            {
                var testContext = new TestServiceContext() { LoggerFactory = loggerFactory };
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(RequestHeadersAreResetOnEachRequest)}_{listenOptions.GetListenOptionsDetails()}"))
            {
                var testContext = new TestServiceContext() { LoggerFactory = loggerFactory };
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(UpgradeRequestIsNotKeptAliveOrChunked)}_{listenOptions.GetListenOptionsDetails()}"))
            {
                var testContext = new TestServiceContext() { LoggerFactory = loggerFactory };
        ...
        {
            using (StartLog(out var loggerFactory, TestConstants.DefaultFunctionalTestLogLevel, $"{nameof(MatchesValidRequestTargetAndHostHeader)}_{request}_{hostHeader}"))
        ...
        private async Task TestRemoteIPAddress(string registerAddress, string requestAddress, string expectAddress, ILoggerFactory loggerFactory)
        {
            var builder = TransportSelector.GetWebHostBuilder()
                .UseKestrel()
